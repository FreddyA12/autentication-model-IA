"""
Django settings for face authentication project.
"""
...
BASE_DIR = Path(__file__).resolve().parent  # web folder
PROJECT_ROOT = BASE_DIR.parent  # APE3 folder
